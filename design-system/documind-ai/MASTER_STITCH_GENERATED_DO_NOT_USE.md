...
>
> This file was auto-generated by a design tool (Stitch) on 2026-08-15. Its color palette
> (purple `#7C3AED`, lavender, `#FAF5FF` background) **directly conflicts** with the project's
> established **Premium Monochrome** design direction.
>
> **The canonical design system is:**
> `design-system/MASTER.md` (project root — hand-authored, monochrome, source of truth)
>
> This file is kept as a reference artifact only. It must NOT be implemented, imported,
> or referenced in any frontend code or documentation.

---

# Stitch-Generated Design System (Archived Reference Only)
